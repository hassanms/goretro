                  ...
                  <ul role="list" class="-my-6 divide-y divide-gray-200">
                    <li class="flex py-6">
                      <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                        <img src="https://icon-library.com/images/cloth-icon/cloth-icon-19.jpg" alt="Salmon orange fabric pouch with match zipper, gray zipper pull, and adjustable hip belt." class="h-full w-full object-cover object-center"></img>
                      </div>
                      ...
                      <div class="ml-4 flex flex-1 flex-col">
                        ...
                        <div class="flex flex-1 items-end justify-between text-sm">
                          ...
                          <div class="flex">
                            <a href="#" class="font-medium text-gray-300 hover:text-blue-900">{item.tier}</a>
                          </div>
                        </div>
                      </div>
                    </li>
          ...
          {/* //End of Cart Object */}
            ...
            <div class=" border-t border-gray-200 py-60 px-10 sm:px-6">
              ...
              <div class="mt-6 flex justify-center text-center text-sm text-gray-500">
                <p>
                  or <a href="./current-stock" class="font-medium text-indigo-600 hover:text-indigo-500">Continue Shopping<span aria-hidden="true"> &rarr;</span></a>
                </p>
              </div>
            </div>
          </div>
